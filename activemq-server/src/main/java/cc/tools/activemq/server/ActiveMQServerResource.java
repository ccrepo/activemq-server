...
/**
 * This class implements a Servlet resource management class.
 * 
 * @author cc
 * @version %I%, %G%
 * @since 0.1
...
public class ActiveMQServerResource {
  ...
  /**
   * Method loads {@link jakarta.servlet.http.HttpServlet} resource indicated by
   * parameter uri value.
   * 
   * @param context Servlet context.
   * @param location contains path to {@link jakarta.servlet.http.HttpServlet}
