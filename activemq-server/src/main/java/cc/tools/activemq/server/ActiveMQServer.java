...
/**
 * This class implements a dynamic {@link jakarta.servlet.Servlet} service for
...
public class ActiveMQServer extends HttpServlet {
   ...
   * 
   * @param config {@link jakarta.servlet.ServletConfig} provided by
   *               {@link jakarta.servlet.http.HttpServlet} container.
  ...
  /**
   * Override of 'service' {@link jakarta.servlet.http.HttpServlet} life cycle
   * method
   * {@link jakarta.servlet.http.HttpServlet#service(HttpServletRequest, HttpServletResponse)}.
   ...
   * 
   * @param request  client {@link jakarta.servlet.http.HttpServletRequest} object.
   * @param response client {@link jakarta.servlet.http.HttpServletResponse} object.
   * @throws IOException      .
   * @throws ServletException .
   */
  @Override
  ...
  /**
   * Method implements this {@link jakarta.servlet.http.HttpServlet} handler for
   * Delete requests. This method overrides {@link jakarta.servlet.http.HttpServlet}
   * method
   * {@link jakarta.servlet.http.HttpServlet#doDelete(HttpServletRequest, HttpServletResponse)}.
   * 
   * @param request  client {@link jakarta.servlet.http.HttpServletRequest} object.
   * @param response client {@link jakarta.servlet.http.HttpServletResponse} object.
   * @throws IOException      .
  ...
  /**
   * Method implements this {@link jakarta.servlet.http.HttpServlet} handler for Get
   * requests. This method overrides {@link jakarta.servlet.http.HttpServlet} method
   * {@link jakarta.servlet.http.HttpServlet#doGet(HttpServletRequest, HttpServletResponse)}.
   * 
   * @param request  client {@link jakarta.servlet.http.HttpServletRequest} object.
   * @param response client {@link jakarta.servlet.http.HttpServletResponse} object.
   * @throws IOException      .
  ...
  /**
   * Method implements this {@link jakarta.servlet.http.HttpServlet} handler for Put
   * requests. This method overrides {@link jakarta.servlet.http.HttpServlet} method
   * {@link jakarta.servlet.http.HttpServlet#doPut(HttpServletRequest, HttpServletResponse)}.
   * 
   * @param request  client {@link jakarta.servlet.http.HttpServletRequest} object.
   * @param response client {@link jakarta.servlet.http.HttpServletResponse} object.
   * @throws IOException      .
  ...
  /**
   * Method implements this {@link jakarta.servlet.http.HttpServlet} handler for
   * Post requests. This method overrides {@link jakarta.servlet.http.HttpServlet}
   * method
   * {@link jakarta.servlet.http.HttpServlet#doPost(HttpServletRequest, HttpServletResponse)}.
   * 
   * @param request  client {@link jakarta.servlet.http.HttpServletRequest} object.
   * @param response client {@link jakarta.servlet.http.HttpServletResponse} object.
   * @throws IOException      .
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) 
    ...
    if (isEndpointLogger(requestContext, requestURI)) {
   ...
   **/
  private boolean isEndpointLogger(String context, String uri) {
    _logger.info("context is " + context);
    return (context + _ENDPOINT_LOGGER).compareToIgnoreCase(uri) == 0;
  }

  /**
   * Parameter constant for the {@link jakarta.servlet.http.HttpServlet} get log Uri
   * '{@value _ENDPOINT_LOGGER}'. The full URL includes the servlet context.
   */
  final public static String _ENDPOINT_LOGGER = "/log";
