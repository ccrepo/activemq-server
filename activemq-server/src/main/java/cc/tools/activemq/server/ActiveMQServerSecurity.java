...
/**
 * This class implements security functions.
 * 
 * @author cc
 * @version %I%, %G%
 * @since 0.1
...
public class ActiveMQServerSecurity {
  ...
  private boolean initCredentialsFromText(String text) {
    ...
    if (lines.length != 3) {
      _logger.severe("wrong number of lines in credentials - found " + lines.length);
   ...
   * {@link java.security.PublicKey} from a {@link jakarta.servlet.http.HttpServlet}
   * Uri path.
   * 
